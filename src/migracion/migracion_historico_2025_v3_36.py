...
v3.36 - CERES CLA + DETECCIÓN PROVEEDOR POR CONTENIDO
      ...
      - Si nombre archivo no identifica proveedor, busca CIF conocido en PDF

v3.35 - FIX CERES SIN_TOTAL
      - Corregido patrón total CERES: "Importe TOTAL" con valor en línea separada
...
v3.21 - VALIDACIÓN DE CUADRE
      - Nueva columna CUADRE: OK / DESCUADRE / SIN_TOTAL / SIN_LINEAS
"""
...
def extraer_lineas_ceres(texto: str) -> List[Dict]:
    ...
    # Formato: "CLA: 1 €" o "CLA: 2 €" al final del documento
    ...
    if cla_match:
        ...
        if cla_cantidad > 0:
            lineas.append({
                ...
                'iva': 21,
                'base': float(cla_cantidad)  # Base = cantidad (1€, 2€, etc.)
            })
