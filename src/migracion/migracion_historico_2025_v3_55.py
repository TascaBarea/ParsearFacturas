...
def extraer_total(texto: str) -> Optional[float]:
    ...
    patrones = [
        ...
        r'TOTAL\s+FACTURA\n[\d,\.\s]+?(\d{1,3}(?:\.\d{3})*[,]\d{2})\s*$',
        # v3.54 - Patrón BORBOTON: "177,70 € 21,00 % 37,32 € 215,02 €"
        # El IVA debe ser 21,00% o 10,00% o 4,00% (no 0,00% que sería una línea de producto)
        # Usamos ?: para no capturar y solo capturar el total final
...
def extraer_lineas_ceres(texto: str) -> List[Dict]:
    ...
    # Patrón envases: CE990001 ENVASE 50 lit. -11 30 21 -330,00
