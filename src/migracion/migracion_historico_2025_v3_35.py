...
v3.35 - FIX CERES SIN_TOTAL
      ...
      - pypdf extrae "Importe TOTAL ........\nNIF:...\n588,06" (salto de línea)
      - Nuevo patrón: Importe TOTAL seguido de valor en línea separada

v3.34 - REFACTOR: Constante VERSION única
      - VERSION definida una sola vez, usada en banner y log
      - Elimina inconsistencias de versión entre ejecución y código

v3.33 - MEJORA EXTRACCIÓN TOTAL (SIN_TOTAL)
      - Añadidos 5 patrones nuevos en extraer_total()
      - Extracción específica CERES en dispatcher

v3.32 - FELISA TRANSPORTE patrón corregido
