...
v3.26b - EXTRACTOR BM PERFECCIONADO
      - BM: Extrae bases imponibles del DESGLOSE FISCAL del ticket
      - Cuadre perfecto usando datos oficiales (Tipo/Base/Iva/Req/Total)
      - Fallback a método por productos si no hay desglose
...
def extraer_total(texto: str) -> Optional[float]:
    """Extrae el total de la factura - v3.25b más conservador."""
...
def main():
    ...
    print("="*60)
    print("MIGRACIÓN HISTÓRICO 2025 - v3.26")
    print("="*60)
