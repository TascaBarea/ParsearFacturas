#!/usr/bin/env python3
"""
MIGRACIÓN HISTÓRICO 2025 - v3.33
================================
...
v3.33 - MEJORA EXTRACCIÓN TOTAL (SIN_TOTAL)
      - Añadidos 5 patrones nuevos en extraer_total():
        * Patrón 11: Total con salto de línea antes del importe
        * Patrón 12: "IMPORTE TOTAL" / "IMPORTE FACTURA"  
        * Patrón 13: "Total:" con variantes de espaciado
        * Patrón 14: "Importe" genérico con €
        * Patrón 15: Captura después de "Cuota IVA"
      - Extracción específica CERES en dispatcher (como SEGURMA)
      - Objetivo: reducir 93 SIN_TOTAL a <20
