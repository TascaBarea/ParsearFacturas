...
v3.43 - ADAPTACIÓN PATRONES PARA PDFPLUMBER
...
def extraer_total(texto: str) -> Optional[float]:
    """Extrae el total de la factura - v3.43 con patrón FRANCISCO GUERRA."""
    ...
    # v3.43: Añadido patrón FRANCISCO GUERRA (BASE TOTAL €)
    patrones = [
        # v3.43 - Patrón FRANCISCO GUERRA - "BASE TOTAL €" en línea final
...
def extraer_lineas_francisco_guerra(texto: str) -> List[Dict]:
    """Extrae líneas de facturas FRANCISCO GUERRA - v3.43 con soporte pdfplumber.
...
def extraer_lineas_bernal(texto: str) -> List[Dict]:
    """Extrae líneas de facturas JAMONES Y EMBUTIDOS BERNAL - v3.43 con pdfplumber.
...
def extraer_lineas_serrin(texto: str) -> List[Dict]:
    """Extrae líneas de facturas SERRÍN NO CHAN - v3.43 con soporte pdfplumber.
